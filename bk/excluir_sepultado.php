...
//$page_nav["Pesquisa"]["sub"]["cadastro"]["active"] = false;
include("inc/nav.php");
						...
						<div>
							...
							<div class="widget-body">
								<?php 
                                    ...
                                    if(isset($_POST['exibe'])){
                                    include("alertas/mens_excluir.php");
                                    }
                                ...
                                <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" class="smart-form" novalidate>
                                    <?php $codigo = $_POST['cod_sep']; ?>
                                    <input type="hidden" name="cod_sep" value="<?php echo $codigo; ?>">
									<fieldset>
										<div class="row">
										</div>
                                    </fieldset>
                                    <footer>
										<button type="submit" name="cancelar" value="cancelar" class="btn btn-primary">
                                          Cancelar
                                        </button>
