							...
							<div class="widget-body">
									 ...
									 <div class="row">
										<section class="col col-2">
											<label class="label">Pesquisar por:</label>
												<label class="select"> 
													<select name="pesquisa" onChange="document.forms['checkout-form'].submit();">
															<option value="0" selected="" disabled="">Pesquisa</option>
															<option value="1">PROPRIETÁRIO</option>
															<option value="2">RESPONSÁVEL</option>
                                                            <option value="3">SEPULTADO</option>
                                                            <option value="4">TÚMULO</option>
													</select>
                                                    <i></i>
												</label>
											</section>
                                ...
                                <?php	
                                    if (isset($_POST['pesquisa'])){
                                        ...
                                        switch (@$buscar) {
                                            case 1:
	                                            include("form_busca_proprietario.php");
                                                break;
                                            case 2:
                                                include("form_busca_responsavel.php");
												
                                                break;
                                            case 3:
                                                include("form_busca_sepultado.php");
                                                break;
											case 4:
												include("form_busca_tumulo.php");
												break;
                                            }
                                ?>
							</div>
