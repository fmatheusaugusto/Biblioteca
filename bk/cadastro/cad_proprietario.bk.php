									...
									<fieldset>
									 	<div class="row">
											...
											<label class="label">Código</label>
												<label class="input"> <i class="icon-prepend fa fa-user"></i>
													<input type="text" name="doc" placeholder="Código(Apenas Números)" autofocus>
												</label>
											</section>
                                            <section class="col col-2">
											<label class="label">CPF</label>
												<label class="input"> <i class="icon-prepend fa fa-user"></i>
													<input type="number" maxlength="15" name="cpf" placeholder="CPF">
												</label>
											</section>
										...
										<section class="col col-3">
											...
											<label class="label">Gaveta</label>
												<label class="input"> <i class="icon-prepend fa fa-building-o"></i>
													<input type="text" name="gaveta" type="number" placeholder="Gaveta (Número)">
												</label>
											</section>
											<section class="col col-3">
