...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>V1.0</title>
				...
				<header id="header">
					...
					<div class="pull-right">
						...
						<div id="fullscreen" class="btn-header transparent pull-right">
							<span> <a href="javascript:void(0);" title="Tela Cheia" data-action="launchFullscreen"><i class="fa fa-arrows-alt"></i></a> </span>
						</div>
